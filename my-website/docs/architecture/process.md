...
<BpmnViewer file="media-and-data/process.bpmn" />

:::tip Навигация по диаграмме
Используй колёсико мыши для масштабирования и перетаскивание для навигации по диаграмме.
:::
